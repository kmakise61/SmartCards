...
// Helper to create cards with NP1 specific defaults
// UPDATED: deckId is now 'np1_set1'
const c = (id: string, deckId: string, front: string, back: string, tags: string[], hint?: string): Flashcard => ({
  id, deckId: 'np1_set1', front, back, tags, hint, status: 'new', interval: 0, easeFactor: 2.5
});
